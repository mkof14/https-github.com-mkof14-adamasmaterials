...
TRANSLATIONS = {
  "ru": {
    ...
    "applications": {
      ...
      "items": {
        "tooling": {"name": "Резцы и инструмент", "desc": "Твёрдость и износостойкость алмаза для пластин, точной обработки и долговечных промышленных режущих кромок."},
        ...
        "semiconductors": {"name": "Полупроводники", "desc": "CVD-алмаз для тепловых узлов, подложек и силовой электроники — RF, оптоэлектроника и приборы, где Si и SiC уже не хватает."},
    ...
    "home": {
      "heroTitle": "Промышленный", "heroAccent": "CVD-алмаз.",
      ...
      "cta": "Запросить предложение", "positioningTitle": "Поставщик CVD-алмаза",
      ...
      "faq": {
        ...
        "items": [
          {"q": "Что вы производите?", "a": "CVD-алмаз и связанные технические решения. HPHT и другие методы синтеза сейчас не предлагаем."},
          {"q": "Почему алмаз для охлаждения и полупроводников?", "a": "У алмаза очень высокая теплопроводность и низкое тепловое расширение. Широкая запрещённая зона и высокая подвижность носителей полезны для теплоотводов и мощной электроники — там, где Si или SiC уже на пределе."},
    ...
    "about": {
      ...
      "metrics": {"founded": "Основана", "hq": "Штаб-квартира", "focus": "Фокус", "industrial": "CVD-алмаз"},
    },
    "investors": {
    ...
    "capabilities": {
      ...
      "cvd": {"title": "Рост CVD-алмаза", "text": "Химическое осаждение из газовой фазы для промышленных и исследовательских марок. Контролируемый рост под инструмент, тепло и полупроводники.", "items": ["CVD-рост", "Выбор марки", "Контроль спецификации"]},
      ...
      "custom": {"title": "Полупроводники и наука", "text": "CVD-алмаз для подложек, мощных RF и силовых приборов, университетских проектов — где важны тепло, напряжение и пределы материала.", "items": ["Подложки", "RF и power", "Университеты", "Заказные спецификации"]},
    ...
    "positioning": {
      "scientificTitle": "Фокус на CVD", "scientificText": "Один процесс: CVD-алмаз с упором на твёрдость, теплопроводность и электронные свойства.",
...
LIGHT = {
  "uk": {
    ...
    "home": {
      "heroTitle": "Промисловий", "heroAccent": "CVD-діамант.",
      ...
      "cta": "Запитати пропозицію", "positioningTitle": "Постачальник CVD-діаманту",
  ...
  "es": {
    ...
    "home": {
      "heroTitle": "Diamante", "heroAccent": "CVD industrial.",
      ...
      "cta": "Solicitar cotización", "positioningTitle": "Proveedor de diamante CVD",
  ...
  "fr": {
    ...
    "home": {
      "heroTitle": "Diamant", "heroAccent": "CVD industriel.",
      ...
      "cta": "Demander un devis", "positioningTitle": "Fournisseur de diamant CVD",
  ...
  "de": {
    ...
    "home": {
      "heroTitle": "Industrieller", "heroAccent": "CVD-Diamant.",
      ...
      "cta": "Angebot anfragen", "positioningTitle": "CVD-Diamant-Lieferant",
  ...
  "ja": {
    ...
    "home": {
      "heroTitle": "産業用", "heroAccent": "CVDダイヤモンド。",
      "heroSubtitle": "切削工具、データセンター冷却、半導体、研究向けのCVDダイヤモンドと技術ソリューション。",
      "cta": "見積依頼", "positioningTitle": "CVDダイヤモンド供給",
