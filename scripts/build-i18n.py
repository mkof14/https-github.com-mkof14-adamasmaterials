...
EN = {
  ...
  "capabilities": {
    ...
    "cvd": {
      ...
      "items": ["CVD growth", "Grade selection", "Spec control", "Batch records"],
    },
    "tooling": {
      ...
      "items": ["Insert blanks", "Wear resistance", "Precision machining", "Pilot to series"],
    },
    "thermal": {
...
TRANSLATIONS = {
  "ru": {
    ...
    "investors": {
      "stewardship": "Инвесторам", "growthMetrics": "Фокус", "revenueTrajectory": "Рынки",
      "capexEfficiency": "Мощности", "ipValuation": "Процесс", "portal": "Доступ инвестора",
    ...
    "capabilities": {
      ...
      "cvd": {"title": "CVD-рост", "text": "Химическое осаждение из газовой фазы для промышленных и исследовательских марок. Контролируем рост под инструмент, тепло и полупроводники — подбираем марку, толщину и форму под задачу. Спецификация и записи партии идут с материалом.", "items": ["CVD-рост", "Выбор марки", "Контроль спецификации", "Записи партии"]},
      "tooling": {"title": "Материалы для резцов", "text": "Экстремальная твёрдость и износостойкость для пластин, заготовок и износостойких деталей. Поддерживаем твёрдую обработку и точные кромки, где ресурс и стабильность размеров определяют себестоимость — от пилота до серийной поставки.", "items": ["Заготовки вставок", "Износостойкость", "Точная обработка", "Пилот — серия"]},
      "thermal": {"title": "Тепловой менеджмент", "text": "Высокая теплопроводность и низкое расширение для теплоотводов и heat spreaders в дата-центрах, чипах, GaN-приборах и силовой электронике. Чиповые spreaders, пластины модулей и заказные тепловые детали под заданный интерфейс и режим работы.", "items": ["Теплоотводы", "Heat spreaders", "Дата-центры", "Силовая электроника"]},
      "custom": {"title": "Полупроводники и наука", "text": "CVD-материалы для подложек, мощных RF и силовых приборов, университетских проектов — где важны тепло, напряжение и пределы материала. Пластины, тепловые пластины и заданные детали для процесса, die-attach, теста и лабораторных исследований.", "items": ["Подложки", "RF и power", "Университеты", "Заказные спецификации"]},
    ...
    "materialsPage": {
      "label": "Каталог", "title": "CVD", "accent": "Материалы.",
      ...
      "specs": "Спецификации", "dataSheet": "Скачать даташит", "grade": "Марка",
    },
    "qualityPage": {
      "label": "Процесс", "title": "Качество и", "accent": "процесс.",
    ...
    "contactPage": {
      "label": "Связь", "title": "Контакты", "accent": "Charlotte, NC.",
      "intro": "Котировки, технические вопросы и логистика для промышленных и научных CVD-проектов.",
      "generalTitle": "Общие", "generalText": "Партнёрства, медиа и общие вопросы.",
      "techTitle": "Техника и наука", "techText": "Спецификации, резцы, тепловые детали, университетские проекты, инженерия.",
      "opsTitle": "Операции", "opsText": "Сроки, статус поставки и координация заказов.",
    },
    "glossaryPage": {
      "label": "Справка", "title": "Технический", "accent": "глоссарий.",
      "intro": "Краткие определения CVD-материалов и применений, с которыми мы работаем.",
      "search": "Поиск термина...", "empty": "Совпадений не найдено.",
    },
    "downloadsPage": {
      "label": "Файлы", "title": "Загрузки", "accent": "Десктоп и мобил.",
      ...
      "overview": "Обзор компании (EN)", "overviewRu": "Обзор компании (RU)",
      "tooling": "CVD резцы — даташит", "thermal": "CVD тепло — даташит",
      "semi": "CVD полупроводники — даташит", "research": "CVD исследования — даташит",
    ...
    "install": {
      ...
      "action": "Установить", "dismiss": "Не сейчас",
    },
    "rfq": {
      ...
      "inquiryLabel": "Запрос", "titlePart1": "Запрос", "titlePart2": "предложения.",
      "intro": "Опишите применение, целевые спецификации и объём. Работаем с промышленными и научными заказчиками по CVD.",
      "name": "Имя", "email": "Корпоративный email", "spec": "Спецификация материала",
      "details": "Детали запроса", "detailsPlaceholder": "Применение, ключевые спецификации, количество и сроки...",
      "received": "Запрос получен.",
      "receivedText": "Конфиденциальность соблюдается. Команда свяжется в течение 48 рабочих часов.",
      "another": "Отправить ещё один запрос", "sla": "Ответ обычно в течение 48 рабочих часов.",
    },
    "footer": {
...
LIGHT = {
  ...
  "ja": {
    ...
    "applications": {
      ...
      "items": {
        "tooling": {"name": "切削工具", "desc": "刃先寿命と寸法安定性が部品単価を左右するインサート、ブランク、耐摩耗部品向けCVDグレード。極端な硬度（最大約100 GPa）と耐摩耗性により、硬質加工、精密仕上げ、熱と摩耗下での長寿命エッジを支えます。インサート形状、コーティング構成、数量に合わせて形態とグレードを合わせ、パイロットから再現可能な供給まで対応します。"},
        "cooling": {"name": "データセンター冷却", "desc": "従来の熱経路を超える高密度ラック、アクセラレータ、パワーモジュール向けヒートシンク／ヒートスプレッダ。高い熱伝導率がホットスポットから熱を速やかに逃がし、低い熱膨張が熱サイクル下でも接合を安定させます。チップ級スプレッダ、モジュール板、データセンター／GaN・RF／パワー向けカスタム熱部品が典型です。"},
        "semiconductors": {"name": "半導体", "desc": "SiやSiCが熱または電圧の限界に達する場合の熱部品、基板、高出力エレクトロニクス向けCVD材料。広いバンドギャップと高いキャリア移動度は、RF増幅器、パワーデバイス、オプトエレクトロニクス、レーザーダイオード／LEDの熱スタックに適します。プロセス装置、ダイアタッチ、試験向けにウェハ、熱板、規定部品を、デバイスとデューティに合わせた仕様で供給します。"},
        "universities": {"name": "大学・研究室", "desc": "熱輸送、電子物性、材料性能を研究する大学・産業ラボ向けカスタムCVDサンプル。熱拡散クーポン、基板研究、パイロット熱プロジェクト、計測・デバイス試作向け小ロットが典型です。仕様、文書、バッチ追跡を納品に含め、ラボ規模から初期パイロットまで対応します。"},
        "technical": {"name": "技術ソリューション", "desc": "熱管理、耐摩耗部品、ウェハ、コーティングなど明確な要件を持つエンジニアリング向け仕様駆動CVD。用途、目標特性、形状、数量を共有いただければ、実用的なグレードと形態の提案で回答します。産業・研究のみ — 明確なRFQ、制御された成長、組立に合う文書。"},
      },
    },
    "capabilities": {
  ...
  "he": {
    ...
    "applications": {
      ...
      "items": {
        "tooling": {"name": "כלי חיתוך", "desc": "דרגות CVD לתוספות חיתוך, blanks וחלקי שחיקה שבהם חיי קצה ויציבות מימדית קובעים עלות ליחידה. קשיות קיצונית (עד ~100 GPa) ועמידות לשחיקה לתמיכה בעיבוד קשה, גימור מדויק וקצוות תעשייתיים ארוכים תחת חום ושחיקה. אנו מתאימים צורה ודרגה לגיאומטריית התוספת, שכבות ציפוי ונפח — ממנות פיילוט ועד אספקה חוזרת."},
        "cooling": {"name": "קירור מרכזי נתונים", "desc": "כיורי חום ו-heat spreaders לארונות צפופים, מאיצים ומודולי הספק שחורגים ממסלולי חום רגילים. מוליכות תרמית גבוהה מסיטה חום מנקודות חמות במהירות; התפשטות נמוכה שומרת על ממשקים יציבים במחזורים תרמיים. עבודה טיפוסית: spreaders ברמת שבב, לוחות מודול וחלקים תרמיים מותאמים למרכזי נתונים, GaN/RF ואלקטרוניקת הספק."},
        "semiconductors": {"name": "מוליכים למחצה", "desc": "חומרי CVD לחלקים תרמיים, מצעים ואלקטרוניקה בהספק גבוה כאשר Si ו-SiC מגיעים לגבולות חום או מתח. פער אסור רחב וניידות נושאים גבוהה תומכים במגברים RF, התקני הספק, אופטו־אלקטרוניקה ומערכות תרמיות לדיודות לייזר / LED. אנו מספקים פרוסות, לוחות תרמיים וחלקים מוגדרים לציוד תהליך, die-attach ובדיקה — עם מפרטים לפי התקן ומחזור העבודה."},
        "universities": {"name": "אוניברסיטאות ומעבדות", "desc": "דגימות CVD מותאמות למעבדות אקדמיות ותעשייתיות החוקרות הולכת חום, תכונות אלקטרוניות וביצועי חומר. בקשות טיפוסיות: קופונים לפיזור חום, מחקרי מצע, פרויקטי חום פיילוט ומנות קטנות למדידה ואבות־טיפוס. מפרט, תיעוד ומעקב אצווה הם חלק מהמסירה — מנפח מעבדה עד פיילוט מוקדם."},
        "technical": {"name": "פתרונות טכניים", "desc": "עבודת CVD מונעת מפרט לצוותי הנדסה עם משימה מוגדרת: ניהול חום, חלקי שחיקה, פרוסות, פתרונות מצופים או דרישות קבועות אחרות. שתפו יישום, תכונות יעד, גיאומטריה ונפח — נשיב בהצעה מעשית לדרגה וצורה. תעשייה ומחקר בלבד: RFQ ברור, גידול מבוקר ותיעוד שמתאים להרכבה."},
      },
    },
    "capabilities": {
