    ...
    translation: {
      ...
      applications: {
        ...
        items: {
          tooling: {
            ...
            desc: 'Экстремальная твёрдость и износостойкость для пластин, точной обработки и долговечных промышленных режущих кромок.'
          },
          cooling: {
          ...
          semiconductors: {
            name: 'Полупроводники',
            desc: 'CVD-материалы для тепловых узлов, подложек и силовой электроники — RF, оптоэлектроника и приборы, где Si и SiC уже не хватает.'
          },
          universities: {
      ...
      capabilities: {
        ...
        custom: {
          ...
          text: 'CVD-материалы для подложек, мощных RF и силовых приборов, университетских проектов — где важны тепло, напряжение и пределы материала.',
          items: [
            'Подложки',
            'RF и power',
            'Университеты',
